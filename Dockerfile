...
RUN dotnet publish "src/BancoItens_WebApi/BancoItens.WebApi.csproj" -c Release -o /publish /p:UseAppHost=false /p:SelfContained=false /p:PublishAot=false
#------------------------------------------------------------------
...
# Comando final para rodar a aplicação (RAILWAYS)
